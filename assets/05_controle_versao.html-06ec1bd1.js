import{_ as s,X as i,Y as n,Z as e,$ as o,a0 as r,a3 as m,a2 as t,E as d}from"./framework-26c8dc72.js";const u={},c=t('<h1 id="controle-de-versao" tabindex="-1"><a class="header-anchor" href="#controle-de-versao" aria-hidden="true">#</a> Controle de Versão</h1><h2 id="cenario-sem-controle-de-versao" tabindex="-1"><a class="header-anchor" href="#cenario-sem-controle-de-versao" aria-hidden="true">#</a> Cenário sem Controle de versão</h2><p>Pense assim, um jornalista iniciante hoje, ou um jornalista nos anos 70 ou 80, não importa. Você está nos primeiros passos, você quer escrever uma notícia.</p><ul><li>Então você abre um editor de textos qualquer e começa a criar arquivos e vai salvando em algum diretório.</li><li>Depois você vai escrever por cima do seu documento de ontem, salvar e descobrir que fez algo errado e agora perdeu a versão anterior.</li><li>Você vai renomear arquivos, sair apagando, e em algum momento vai apagar um arquivo que não devia. (Quem nunca?)</li><li>Depois de apagar coisas por acidente algumas vezes, você vai começar a duplicar os arquivos antes de editar.</li><li>Então, você vai começar a ter versões diferentes do mesmo documento no diretório.</li><li>Eu cansei de fazer isso e cansei de ver documentos de outras pessoas cheios de versões antigas que não deveriam estar lá.</li></ul><p>E aqui vem o segundo problema, você precisa que outro jornalista trabalhe na mesma notícia. Uma das maneiras de fazer isso é colocar o diretório do projeto em alguma pasta compartilhada na rede local. Então, acontece de ambos abrirem o mesmo documento para editar. Você edita e salva primeiro. Então, o segundo jornalista edita a parte dele salva por cima! E pronto, você acabou de perder o que estava fazendo.</p><h2 id="conceito-controle-de-versao" tabindex="-1"><a class="header-anchor" href="#conceito-controle-de-versao" aria-hidden="true">#</a> Conceito Controle de Versão:</h2><p>O controle de versão refere-se ao gerenciamento e rastreamento de alterações feitas em um conjunto de arquivos ao longo do tempo. Ele permite que os desenvolvedores acompanhem as modificações feitas em seu código-fonte, arquivos de configuração, documentos e outros ativos do projeto. O controle de versão é essencial para o trabalho colaborativo e o desenvolvimento de software, pois permite que várias pessoas trabalhem no mesmo projeto, façam alterações independentes em arquivos diferentes e depois combinem essas alterações de forma controlada. Os sistemas de controle de versão, como Git, Subversion e Mercurial, são projetados especificamente para gerenciar e controlar as versões de arquivos.</p><h3 id="principais-vantagens" tabindex="-1"><a class="header-anchor" href="#principais-vantagens" aria-hidden="true">#</a> Principais vantagens</h3><p><sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1"></a></sup></p><p>As principais vantagens de se utilizar um sistema de controle de versão para rastrear as alterações feitas durante o desenvolvimento de software ou o desenvolvimento de um documento de texto qualquer são:</p><ul><li><strong>Controle do histórico</strong>: facilidade em desfazer e possibilidade de analisar o histórico do desenvolvimento, como também facilidade no resgate de versões mais antigas e estáveis. A maioria das implementações permitem analisar as alterações com detalhes, desde a primeira versão até a última.</li><li><strong>Trabalho em equipe</strong>: um sistema de controle de versão permite que diversas pessoas trabalhem sobre o mesmo conjunto de documentos ao mesmo tempo e minimiza o desgaste provocado por problemas com conflitos de edições. É possível que a implementação também tenha um controle sofisticado de acesso para cada usuário ou grupo de usuários.</li><li><strong>Marcação e resgate de versões estáveis</strong>: a maioria dos sistemas permite marcar onde é que o documento estava com uma versão estável, podendo ser facilmente resgatado no futuro.</li><li><strong>Ramificação de projeto</strong>: a maioria das implementações possibilita a divisão do projeto em várias linhas de desenvolvimento, que podem ser trabalhadas paralelamente, sem que uma interfira na outra.</li><li><strong>Segurança</strong>: Cada software de controle de versão usa mecanismos para evitar qualquer tipo de invasão de agentes infecciosos nos arquivos. Além do mais, somente usuários com permissão poderão mexer no código.</li><li><strong>Rastreabilidade</strong>: Com a necessidade de sabermos o local, o estado e a qualidade de um arquivo; o controle de versão traz todos esses requisitos de forma que o usuário possa se embasar do arquivo que deseja utilizar.</li><li><strong>Organização</strong>: Alguns softwares disponibilizam uma interface visual onde podem ser vistos todos os arquivos controlados, desde a origem até o projeto por completo.</li><li><strong>Confiança</strong>: O uso de repositórios remotos (na nuvem) ajuda a não perder arquivos por eventos inesperados. Além disso, e possível fazer novos projetos sem danificar o desenvolvimento do atual.</li></ul><h3 id="controle-de-versao-local" tabindex="-1"><a class="header-anchor" href="#controle-de-versao-local" aria-hidden="true">#</a> Controle de versão local</h3><p>No início da programação de software, os desenvolvedores costumavam usar métodos simples para controlar suas versões localmente. Isso envolvia fazer cópias de segurança manuais dos arquivos de código-fonte em diretórios diferentes ou usando ferramentas básicas, como a criação de arquivos com diferentes extensões (por exemplo, &quot;script_v1.py&quot;, &quot;script_v2.py&quot;, etc.).</p><ul><li><p><em>SCCS (Source Code Control System)</em>: Em meados dos anos 70, o SCCS foi o primeiro sistema de controle de versão criado. Ele permitia aos desenvolvedores criar um repositório centralizado onde podiam armazenar e controlar as alterações em seus arquivos de código-fonte. No entanto, o SCCS tinha suas limitações e só funcionava em sistemas UNIX.</p></li><li><p><em>RCS (Revision Control System)</em>: Na década de 1980, o RCS foi desenvolvido como uma evolução do SCCS. Ele introduziu recursos adicionais, como a capacidade de mesclar alterações de diferentes desenvolvedores e rastrear as modificações com mais precisão. O RCS ainda é usado em alguns ambientes Unix, mas foi substituído por sistemas mais avançados em muitos contextos.</p></li><li><p><em>CVS (Concurrent Versions System)</em>: Lançado em 1986, o CVS foi o primeiro sistema de controle de versão a permitir a colaboração em tempo real entre os desenvolvedores. Ele introduziu a noção de um repositório centralizado acessado por várias pessoas, facilitando a mesclagem de alterações e o acompanhamento do histórico do projeto. O CVS foi amplamente adotado no mundo do software livre e de código aberto.</p></li></ul><figure><img src="https://www.plantuml.com/plantuml/svg/dPB1QeGm48RlUOh1dfLEl7MXh1dO5oZqKde8PhehkA5e2eNITszY4jT8J-iXcV_tct-2yJWxFRclwoW-Xf6XYvkA6mdHGTEyNGPZsBvxMssbVprnxxGz1_Rr1Nu4-2S68UWPgWwRnmfkjegssjaKRThP7QufMC73fnxvF37RmpXOVhgLZT7pXSt1yRUBzdRYEXBBaUjCB4yeCozBNcPUtd-MDcUtTsJqmzI7ht9QGg3Qcke_amfpMVozR2yK5rCL9g58w8xDy8xEEDJFlYSoeKxX56h2FBqEkMk-LoUHpr0NCuAIISb5jKcrGQKs2Y2bDiAeP5AXZJpuAyIHhV5_-Hy0" alt="uml diagram"><figcaption>Representação do versionamento com CVS</figcaption></figure><ul><li><em>SVN (Subversion)</em>: O SVN surgiu no início dos anos 2000 como uma alternativa ao CVS. Ele corrigiu algumas das deficiências do CVS e ofereceu recursos mais avançados, como versionamento de diretório, suporte a arquivos binários e a capacidade de renomear e mover arquivos sem perder o histórico. O SVN também tinha um modelo de repositório centralizado.</li></ul><figure><img src="https://www.plantuml.com/plantuml/svg/RP713e8m38RlVOg6EsIRTmFRtOCcN8m78bD940tWoVZkTbI14hXq-zhi_rBIhY_Q_dMluLBL7ZCkbei3o319ZhUgB7rp8cpdLsgt_jmNpPLc3_bkxv-FNECRa3v-JcFHOPJfH4KuOSlOBh1Zx1WFd1wOv-i1MW6TXa_mZBSqJO9KQSw5IgqLGoCDHqKj5KT7FSaiR3XPOnnQOCCXm9NCZSmq_qmZCjM0KUvaNChCmmWFnLjHSYi_EROpuC8XKA2Ha0MfRqhwyLy0" alt="uml diagram"><figcaption>Representação do versionamento com SVN</figcaption></figure><h3 id="sistemas-de-controle-de-versao-distribuidos" tabindex="-1"><a class="header-anchor" href="#sistemas-de-controle-de-versao-distribuidos" aria-hidden="true">#</a> Sistemas de controle de versão distribuídos</h3><p>A próxima grande evolução veio com o surgimento dos sistemas de controle de versão distribuídos, que não dependiam mais de um repositório centralizado. Dois sistemas que se destacaram foram o Git e o Mercurial.</p><ul><li><p><em>Mercurial</em>: Lançado em 2005, o Mercurial foi desenvolvido como uma alternativa ao Git, oferecendo recursos semelhantes de controle de versão distribuído. O Mercurial foi projetado para ser fácil de usar e flexível, com uma ênfase na simplicidade e consistência do design. Embora não tenha alcançado a mesma popularidade do Git, o Mercurial ainda é utilizado em alguns projetos e organizações.</p></li><li><p><em>Git</em>: Criado por Linus Torvalds em 2005, o Git rapidamente se tornou o sistema de controle de versão mais popular e amplamente utilizado. Ele foi projetado para ser rápido, eficiente e escalável, permitindo que os desenvolvedores trabalhassem offline, realizassem ramificações e mesclas facilmente, e colaborassem em projetos de maneira distribuída. O Git é usado em uma ampla gama de projetos, desde pequenos repositórios pessoais até grandes projetos de código aberto.</p></li></ul><h3 id="outros-sistemas-de-controle-de-versao" tabindex="-1"><a class="header-anchor" href="#outros-sistemas-de-controle-de-versao" aria-hidden="true">#</a> Outros sistemas de controle de versão:</h3><p>Além do Git e do Mercurial, existem outros sistemas de controle de versão distribuídos e centralizados disponíveis, como Bazaar, Perforce, TFS (Team Foundation Server), entre outros. Cada um desses sistemas tem suas próprias características e benefícios, e a escolha do sistema de controle de versão depende das necessidades e preferências específicas de cada equipe ou projeto.</p><p>Ao longo dos anos, os sistemas de controle de versão evoluíram para fornecer recursos mais avançados, como ramificações e mesclas mais eficientes, rastreamento detalhado de alterações, suporte a fluxos de trabalho complexos e integração com outras ferramentas de desenvolvimento. Além disso, surgiram serviços de hospedagem de código, como GitHub e GitLab, que facilitam o compartilhamento e a colaboração em projetos baseados em Git.</p>',23),p={href:"https://git-scm.com/book/pt-br/v2",target:"_blank",rel:"noopener noreferrer"},l={href:"https://github.com/20231-ifba-saj-ads-tawii/repo_teste",target:"_blank",rel:"noopener noreferrer"},v=e("hr",{class:"footnotes-sep"},null,-1),q={class:"footnotes"},f={class:"footnotes-list"},g={id:"footnote1",class:"footnote-item"},b={href:"https://blog.wkm.com.br/o-que-%C3%A9-e-porque-usar-um-sistema-de-controle-de-vers%C3%A3o-23f00b08e12d",target:"_blank",rel:"noopener noreferrer"},h=e("a",{href:"#footnote-ref1",class:"footnote-backref"},"↩︎",-1);function j(S,x){const a=d("ExternalLinkIcon");return i(),n("div",null,[c,e("p",null,[e("a",p,[o("Link ebook GIT"),r(a)])]),e("p",null,[e("a",l,[o("Repositório para teste"),r(a)])]),m(` 
...
`),v,e("section",q,[e("ol",f,[e("li",g,[e("p",null,[o("O que é e porque usar um sistema de controle de versão? "),e("a",b,[o("https://blog.wkm.com.br/o-que-%C3%A9-e-porque-usar-um-sistema-de-controle-de-vers%C3%A3o-23f00b08e12d"),r(a)]),o(),h])])])])])}const E=s(u,[["render",j],["__file","05_controle_versao.html.vue"]]);export{E as default};
